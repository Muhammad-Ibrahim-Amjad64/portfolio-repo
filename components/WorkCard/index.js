...
const WorkCard = ({
  ...
  return (
    <div
      ...
      className=" rounded-lg ph-2  first:ml-0 link bg-slate-800 hover:bg-black duration-300 p-3  flex flex-col  justify-between "
    >
      <div >
        <div
        ...
        <h2 className="font-sans font-semibold">{descriptionLarge}</h2>
      </div>
      {/* child 1  */}
      <div className="my-4">
